...
class CustomWhiteTextTheme {
  static CustomWhiteTextTheme? _instance;
  static CustomWhiteTextTheme? get instance {
    _instance ??= CustomWhiteTextTheme._init();
    return _instance;
  }

  CustomWhiteTextTheme._init();
  final TextStyle headlineLarge = TextStyle(
    color: CustomColorScheme.instance!.whiteColor,
    fontFamily: 'Poppins',
    fontSize: 24,
  );
